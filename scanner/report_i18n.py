...
REPORT_I18N = {
    "zh": {
        ...
        "filters": {"all": "全部", "yes": "可达", "no": "不可达", "uncertain": "不确定", "failed": "复核失败",
                    "unverified": "未复核"},
        "reachable": {"yes": "可达", "static": "静态确认", "no": "不可达", "uncertain": "不确定", "failed": "复核失败",
                      "unverified": "未复核"},
        ...
        "card": {
            ...
            "remediation": "修复建议:",
            "duplicates": "相同代码另见:",
            "unverifiedNote": "这条候选没有经过 LLM 复核 —— 复核阶段因为接口限流提前结束了。它既不是安全的,也不是不确定的,只是还没有人判断过。",
        },
    ...
    "en": {
        ...
        "filters": {"all": "All", "yes": "Reachable", "no": "Not reachable", "uncertain": "Uncertain",
                    "failed": "Failed", "unverified": "Not verified"},
        "reachable": {"yes": "Reachable", "static": "Statically confirmed", "no": "Not reachable", "uncertain": "Uncertain",
                      "failed": "Verify failed", "unverified": "Not verified"},
        ...
        "card": {
            ...
            "unverifiedNote": "This candidate was never verified -- the verify stage stopped early because the provider rate-limited it. It is not safe and not uncertain, just unjudged.",
        },
